document.addEventListener('DOMContentLoaded', () => {
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      e.preventDefault();
      alert('Agradecemos tu interés en Aura&Lino. Nos pondremos en contacto contigo a la brevedad.');
      form.reset();
    });
  }
});
